...
char *s21_strchr(const char *a, int c);
...
/*__________________________________SPRINTF_____________________________________*/
...
int s21_ch_type(struct processing *p, char *str, va_list arg, int *change);
...
void s21_ftoa(struct processing *p, char *str, long double value);
void s21_reverse(char* str, int len);
int s21_intToStr(int x, char str[], int d);

/*___________________________________ERROR_____________________________________*/

#ifdef __APPLE__
// #define MAX_ELEMENT 107
#define ERRORS {\
    "Undefined error: 0", \
